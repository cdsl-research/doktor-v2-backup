...
SLACK_WEBHOOK_URL=$(cat /volume1/doktor-dev-backup/slack-webhook.env)
slack () {
...
MESSAGE="[DEV] Data dump has been stored on natadecoco: /volume1/doktor-dev-backup/$LATEST_BACKUP_DIR\n\`\`\`\n$DIR_CONTENTS\n\`\`\`"
slack "$MESSAGE"